...
Call log:
  - waiting for getByTestId('card-inside-card-cart').locator('input[name=\'email\']')
...
> 37 |         await card.locator("input[name='email']").fill("deepali.sri@gamil.com");
     |                                                   ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  38 |         await card.locator("input[name='password']").fill("123456");
