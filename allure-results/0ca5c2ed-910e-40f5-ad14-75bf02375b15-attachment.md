...
Call log:
  - waiting for getByText('Azure', { exact: true })
    - locator resolved to <div role="option" data-value="Azure" class="tta-rs__option">Azure</div>
...
> 26 |  await page.getByText('Azure',{exact: true}).click();
     |                                              ^ Error: locator.click: Target page, context or browser has been closed
  27 |  
  28 |  await page.pause();
  29 |  
