...
Call log:
  - waiting for getByText('login-button')
          ...
          - complementary [ref=e553]:
            - region "Student Login" [ref=e554]:
              ...
              - generic [ref=e560]:
                ...
                - generic [ref=e567]:
                  - generic [ref=e568]:
                    - checkbox "Remember me" [checked] [active] [ref=e569]
                    - text: Remember me
...
> 12 |     await page.getByText("login-button").click();
     |                                          ^ Error: locator.click: Test timeout of 30000ms exceeded.
  13 | 
  14 |     let urlText = page.url().includes("#login-sucess");
  15 |     console.log(urlText);
  16 |     
  17 |     
  18 | 
  19 | 
