...
- Name: 07_WebTables\07_WebTable_Xpath_PaginationForLoop_Fn.spec.ts >> Verify Element by filter
- Location: tests\07_WebTables\07_WebTable_Xpath_PaginationForLoop_Fn.spec.ts:22:5
        ...
        - region "Paginated employees table workspace" [ref=e612]:
          - generic [ref=e613]:
            ...
            - table "Employees table" [ref=e626]:
              ...
              - rowgroup [ref=e634]:
                - row "9 Sofia Rossi SDET sofia@tta.dev Italy" [ref=e635]:
                  - cell "9" [ref=e636]
                  - cell "Sofia Rossi" [ref=e637]
                  - cell "SDET" [ref=e638]
                  - cell "sofia@tta.dev" [ref=e639]
                  - cell "Italy" [ref=e640]
                - row "10 Giulia Bianchi QA Engineer giulia@tta.dev Italy" [ref=e641]:
                  - cell "10" [ref=e642]
                  - cell "Giulia Bianchi" [ref=e643]
                  - cell "QA Engineer" [ref=e644]
                  - cell "giulia@tta.dev" [ref=e645]
                  - cell "Italy" [ref=e646]
                - row "11 Marco Conti Manual QA marco@tta.dev Italy" [ref=e647]:
                  - cell "11" [ref=e648]
                  - cell "Marco Conti" [ref=e649]
                  - cell "Manual QA" [ref=e650]
                  - cell "marco@tta.dev" [ref=e651]
                  - cell "Italy" [ref=e652]
                - row "12 Luca Greco SDET luca@tta.dev Italy" [ref=e653]:
                  - cell "12" [ref=e654]
                  - cell "Luca Greco" [ref=e655]
                  - cell "SDET" [ref=e656]
                  - cell "luca@tta.dev" [ref=e657]
                  - cell "Italy" [ref=e658]
                - row "13 Hiroshi Tanaka Automation Lead hiroshi@tta.dev Japan" [ref=e659]:
                  - cell "13" [ref=e660]
                  - cell "Hiroshi Tanaka" [ref=e661]
                  - cell "Automation Lead" [ref=e662]
                  - cell "hiroshi@tta.dev" [ref=e663]
                  - cell "Japan" [ref=e664]
                - row "14 Yuki Sato QA Engineer yuki@tta.dev Japan" [ref=e665]:
                  - cell "14" [ref=e666]
                  - cell "Yuki Sato" [ref=e667]
                  - cell "QA Engineer" [ref=e668]
                  - cell "yuki@tta.dev" [ref=e669]
                  - cell "Japan" [ref=e670]
                - row "15 Kenji Watanabe Performance QA kenji@tta.dev Japan" [ref=e671]:
                  - cell "15" [ref=e672]
                  - cell "Kenji Watanabe" [ref=e673]
                  - cell "Performance QA" [ref=e674]
                  - cell "kenji@tta.dev" [ref=e675]
                  - cell "Japan" [ref=e676]
                - row "16 Aiko Mori SDET aiko@tta.dev Japan" [ref=e677]:
                  - cell "16" [ref=e678]
                  - cell "Aiko Mori" [ref=e679]
                  - cell "SDET" [ref=e680]
                  - cell "aiko@tta.dev" [ref=e681]
                  - cell "Japan" [ref=e682]
            - generic [ref=e683]:
              - generic [ref=e684]: Showing 9–16 of 24
              - generic [ref=e685]:
...
```ts
  ...
  2  | 
  3  | async function findRowByName(page: Page, name: string): Promise<Locator> {
  4  | while(true){
  5  |     const row =  page.locator("#employees-tbody tr").filter({hasText: name});
  6  |     if(await row.count()){
  7  |         break;
  8  |     }
  9  | 
  10 |     const nextButton = page.getByTestId("next-page");
  11 |     if(await nextButton.isDisabled()){
  12 |         throw new Error(`Row with name ${name} not found in the table`);
  13 |     }
  14 |     await nextButton.click();
  15 |     }
  16 | 
  17 | 
  18 | }
  ...
  20 | 
  21 | 
  22 | test("Verify Element by filter", async({page}) => {
  23 | 
  24 | await page.goto("https://app.thetestingacademy.com/playwright/tables/webtable");
  25 | 
  26 | 
  27 |     let name : string = "Luca Greco";
  28 |     const row = await findRowByName(page, 'Luca Greco');
> 29 |     const email = await row.locator("td[data-col='email']").innerText();
     |                             ^ TypeError: Cannot read properties of undefined (reading 'locator')
  30 |     console.log(email);
  31 |     const country = await row.locator("td[data-col='country']").innerText();
  32 |     console.log(country);
  33 | 
