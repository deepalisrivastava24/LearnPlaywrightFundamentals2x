...
- Name: 10_Keyboard_Hover_Drag_Drop\Task_Hover.spec.ts >> Verify keyboard hover and drag and drop
- Location: tests\10_Keyboard_Hover_Drag_Drop\Task_Hover.spec.ts:3:5

# Error details

```
Error: locator.count: SyntaxError: Failed to execute 'evaluate' on 'Document': Type conversion failed while evaluating the expression.
        ...
        - generic [ref=e533]:
          - article [ref=e535]:
            ...
            - navigation "Travel main" [ref=e539]:
              ...
              - generic [ref=e542]:
                - text: Add-ons
                - menu "Add-ons submenu" [ref=e543]:
                  - menuitem "🚖 Taxi" [ref=e544] [cursor=pointer]:
                    - generic [ref=e545]: 🚖
                    - text: Taxi
                  - menuitem "🏨 Hotel" [ref=e546] [cursor=pointer]:
                    - generic [ref=e547]: 🏨
                    - text: Hotel
                  - menuitem "🛡️ Insurance" [ref=e548] [cursor=pointer]:
                    - generic [ref=e549]: 🛡️
                    - text: Insurance
                  - menuitem "🍽️ Meal" [ref=e550] [cursor=pointer]:
                    - generic [ref=e551]: 🍽️
                    - text: Meal
                  - menuitem "📶 Wi-Fi" [ref=e552] [cursor=pointer]:
                    - generic [ref=e553]: 📶
                    - text: Wi-Fi
                  - menuitem "🎟️ Activities" [ref=e554] [cursor=pointer]:
                    - generic [ref=e555]: 🎟️
                    - text: Activities
              - generic [ref=e556]: Holidays
              - generic [ref=e557]: Account › ›
            - generic [ref=e558]:
              - generic [ref=e559]:
                - generic [ref=e560]: data-testid
              ...
              - generic [ref=e563]:
                - generic [ref=e564]: nested
                - text: =test-id-Upcoming · test-id-Past · test-id-Cancelled (Account → Bookings)
            - generic [ref=e565]: No item clicked yet.
          - complementary [ref=e566]:
            - generic [ref=e567]:
              - heading "What students should practise" [level=3] [ref=e568]
              - list [ref=e569]:
                - listitem [ref=e570]:
                  - text: Hover
                  - code [ref=e571]: data-testid="nav-add-ons"
                  - text: ", then click"
                  - code [ref=e572]: data-testid="test-id-Taxi"
                  - text: .
                - listitem [ref=e573]:
                  - text: Use
                  - code [ref=e574]: "getByText('Add-ons', { exact: true }).hover()"
                  - text: +
                  - code [ref=e575]: getByTestId('test-id-Taxi').click()
                  - text: .
                - listitem [ref=e576]:
                  - text: Hover
                  - emphasis [ref=e577]: Account
                  - text: ", hover"
                  - emphasis [ref=e578]: Bookings
                  - text: (chevron item), click
                  - emphasis [ref=e579]: Upcoming
                  - text: .
                - listitem [ref=e580]:
                  - text: Assert the submenu becomes visible only after hover (
                  - code [ref=e581]: toBeVisible()
                  - text: on hover,
                  - code [ref=e582]: toBeHidden()
                  - text: after mouse-out).
                - listitem [ref=e583]:
                  - text: Read every Add-ons child text via
                  - code [ref=e584]: locator('.submenu .submenu-item').allInnerTexts()
                  - text: after hover.
            - group [ref=e585]:
              - generic "Playwright solution Single hover, then nested hover. Show solution" [ref=e586] [cursor=pointer]:
                - img [ref=e588]
                - generic [ref=e590]:
                  - strong [ref=e591]: Playwright solution
                  - generic [ref=e592]: Single hover, then nested hover.
                - generic [ref=e593]: Show solution
```