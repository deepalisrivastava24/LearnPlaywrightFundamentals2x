...
- Name: 06_Multiple_Element_\Task_Student_Login.spec.ts >> Verify element by filter
- Location: tests\06_Multiple_Element_\Task_Student_Login.spec.ts:3:5
...
Received: "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=abcd%40abcd.com&password=abcd&remember=yes#login-success"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    12 × unexpected value "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=abcd%40abcd.com&password=abcd&remember=yes#login-success"
...
```ts
  ...
  4  | 
  5  |     page.goto("https://app.thetestingacademy.com/playwright/multiple_element_filter");
  6  | 
  7  |     await page.waitForLoadState('networkidle');
  8  | 
  9  |     await page.locator("#email").fill("abcd@abcd.com");
  10 |     await page.locator('#password').fill("abcd");
  11 |     await page.getByRole('checkbox').check();
  12 |     await page.getByTestId("login-button").click();
  13 | 
  14 |     let expectedUrl= "https://app.thetestingacademy.com/playwright/multiple_element_filter?email=abcd%40abcd.com&password=abcd&remember=yes#login-success"
> 15 |     await expect(page).toHaveURL('#login-success');
     |                        ^ Error: expect(page).toHaveURL(expected) failed
  16 |     //**/#/dashboard
  17 |     console.log("Test Sucessful");   
  18 |     
  19 | 
  20 | 
  21 | });
